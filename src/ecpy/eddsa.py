...
if __name__ == "__main__":
    try:
        ...
        expected_sig = int(0x92a009a9f0d4cab8720e820b5f642540a2b27b5416503f8fb3762223ebdb69da085ac1e43e15996e458f3613d0f11d8c387b2eaeb4302aeeb00d291612bb0c00).to_bytes(64, 'big')

        #msg:
        # 72
        msg  = int(0x72).to_bytes(1, 'big')
        ...
        expected_sig = int(0x477dedac6d8332708e00a7c06ceeda54f2086ba73e71e8988b3760ccd23e0c4408cf09c22ef497328579f6178e8a2a4d611d0c6cce0c684f958d150c5daf4902 ).to_bytes(64, 'big')

        #msg:
        # 72
        msg  = int(0xe8898b646cc2274b5daf7fb6e30f738b24203604d7849391056d0fe8093f6693).to_bytes(32, 'big')
        ...
        #
        #
        expected_sig = int(0xa2ce8472cf883cca5f98ca76d5834831d9d121a755c00daa385d0bac145203269e572a3d1f221af1b1ca6feaae05141a9aa9d6990163a85ab8690da44c056d0f).to_bytes(64, 'big')

        #msg:
        # 72
        msg  = int(0xe8898b646cc2274b5daf7fb6e30f738b24203604d7849391056d0fe8093f669338b24203604d7849391056d0fe8093f6693e8898b646cc2274b5daf7fb6e30f7).to_bytes(64, 'big')
        ...
        # sig:
        #
        expected_sig = int().to_bytes(132, 'big')
